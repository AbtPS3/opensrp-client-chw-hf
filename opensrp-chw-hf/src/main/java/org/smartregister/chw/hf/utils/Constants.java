...
public class Constants extends CoreConstants {
    ...
    public static String FILTER_INDEX_CONTACTS_ELICITATION_STATUS = "FILTER_INDEX_CONTACTS_ELICITATION_STATUS";
    ...
    public static String ENABLE_APPOINT_DATE_FILTER = "ENABLE_APPOINT_DATE_FILTER";

    public static String ENABLE_INDEX_CONTACTS_ELICITATION_STATUS_FILTER = "ENABLE_INDEX_CONTACTS_ELICITATION_STATUS_FILTER";
