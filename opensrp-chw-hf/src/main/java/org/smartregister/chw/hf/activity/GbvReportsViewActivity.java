...
public class GbvReportsViewActivity extends HfReportsViewActivity {
    public static void startMe(Activity activity, String reportPath, int reportTitle, String reportDate) {
        Intent intent = new Intent(activity, GbvReportsViewActivity.class);
        ...
        intent.putExtra(ARG_REPORT_TYPE, Constants.ReportConstants.ReportTypes.GBV_REPORT);
